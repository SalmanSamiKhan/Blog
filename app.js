...
app.post('/compose', function (req, res) {
  ...
  posts.push(post) // pushing this js obj to posts array
...
app.get('/posts/:topic', function (req, res) {
  posts.forEach(function (post) { // iterating over posts array
    if (_.lowerCase(post.title) === _.lowerCase(req.params.topic)) { //using lodash checking if post title and topic in url is same
